...
using OnlineShopOnCore.Library.Clients.OrdersService;
using OnlineShopOnCore.Library.options;
using OnlineShopOnCore.Library.OrdersService.Models;
using IdentityModel.Client;

namespace OnlineShopOnCore.OrdersService.ApiTests
{
    internal class OrderedArticlesRepoClientTests
    {
       ...
       // private IdentityServerClient _identityServerClient;
        ...
        public async Task Setup()
        {
            ...
            serviceAdressOptionsMock.Setup(m => m.Value).Returns(new ServiceAdressOptions() { OrderService = "https://localhost:5005", IdentityServer = "https://localhost:5001" });
